...
- Не се възползват от ефекта на [сложната лихва](/dict/compounding), както натрупващите (Accumulating) ETF.
...
##### Предимства
- **Ефект на [сложната лихва](/dict/compounding)**: Реинвестирането на приходите увеличава потенциала за растеж на инвестицията.
