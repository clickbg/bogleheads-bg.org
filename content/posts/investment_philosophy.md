...
[Простото портфолио](/posts/simple_portfolio_example) има много предимства. Почти винаги намалява разходите (включително данъците), прави анализа по-лесен, опростява повторното ребалансиране, опростява подготовката на данъчната декларация, намалява документацията и воденето на записи и улеснява наследниците ви ако наследят инвестициите ви. Най-хубавото от всичко е, че простото портфолио ви позволява да прекарвате повече време със семейството и приятелите и по-малко време за управление на финансите си.
