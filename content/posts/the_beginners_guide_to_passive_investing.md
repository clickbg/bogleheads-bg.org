...
Ако никога не сте отделяли време да научите за основите на инвестирането, направите го сега. Има няколко лесни за четене книги, които не изискват задълбочени познания по математика или финанси и не изискват часове за четене. Например тази добра електронна книга е достъпна за безплатно изтегляне: [If You Can: How Millennials Can Get Rich Slowly](https://www.etf.com/docs/IfYouCan.pdf)
...
> За съжаление, много от най-добрите книги за пасивни инвестиции са написани за инвеститори от САЩ и съдържат препратки към конкретни инвестиционни продукти или сметки, достъпни само там. Тези книги често обсъждат инструменти като 401(k), IRA и други, които не са приложими за българските инвеститори поради значителните разлики в данъчните системи на САЩ и България.
>  
> За щастие, общите принципи на инвестирането са универсални и важат за хората по целия свят. На този сайт ще се опитаме да следваме методологията за пасивни инвестиции, като същевременно предоставяме данъчни и други съвети, приложими за българските инвеститори.
...
![България](/img/bgflag.png)
> За съжаление, към момента на писане на тази статия, инвеститорите от България нямат достъп до взаимни [индексни фондове](/dict/index_fund) с ниски такси (под 1%). Най-оптималната стратегия за нас, българите, към момента е да купуваме [борсово търгувани фондове (ETF)](/dict/etf) на регулираните европейски борси в евро, вместо в левове.
>  
> Нашият откровен съвет е да избягвате активните взаимни фондове, предлагани от българските банки, тъй като те са с твърде високи такси и необмислени стратегии.
...
![България](/img/bgflag.png)
> Към момента на публикуването на тази статия, българските граждани, живеещи в България и притежаващи фондове или UCITS ETF, търгувани на регулирани борси, членове на ESMA, са освободени от данък печалба.
>  
> При закупуване на UCITS ETF не е от значение борсата, от която го купувате. Въпреки това, при продажба на даден фонд, за да бъдете освободени от данъци, трябва да продавате на борси, регулирани от ESMA, и да внимавате дали вашият брокер не практикува OTC продажби, тъй като те се облагат с данък. 
>  
> Повече информация можете да намерите в статията ни за [Данъци в България](/posts/taxes_in_bulgaria)
...
[Пенсионните фондове с целева дата](/dict/balanced_fund) автоматично се ребалансират вместо вас. Пример за подобни [UCITS фондове може да намерите тук](https://www.justetf.com/en/search.html?query=lifestrategy&search=ETFS).
