...
-   Създайте си фонд за спешни случаи - спестяването на сума равна на разходите ви за три до шест месеца е често срещан подход.
...
![България](/favicon-32x32.png) България
...
LINK: https://www.bogleheads.org/wiki/Stock_asset_allocation_for_non-US_investors
...
LINK: https://www.bogleheads.org/wiki/Bond_basics_for_non-US_investors
LINK: https://www.bogleheads.org/wiki/Cash_equivalents_for_EU_investors
...
LINK: https://www.bogleheads.org/wiki/Building_a_non-US_Boglehead_portfolio

Вместо да се опитват да изберат конкретни фирми или сектори от пазара, които на теория биха могли да надминат общия пазар в бъдеще, пасивните инвеститори купуват фондове, които са широко диверсифицирани или дори се доближават до притежание целия пазар. Най-добрият и най-евтиният начин за закупуване на цели фондови пазари и пазари на облигации е с индексни фондове, традиционни взаимни фондове или борсово търгувани фондове (ETF). Пасивните инвеститори си създават личен план за инвестиране, избягват опитите да предскажат пазара и следват този план в добри и лоши времена. Това постоянство води до добри резултати в дългосрочен план.

За жалост към момента на писане на тази статия инвеститорите от България нямат достъп до взаимни индекс фондове с ниски такси (под 1%). За момента най-оптималната стратегия за нас българите е да купуваме борсово търгувани фондове (ETF) на регулираните европейски борси в евро вместо в левове. Нашия откровен съвет е да избягвате активните взаимни фондове предлагани от българските банки защото те са с твърде големи такси и необмислени стратегии.

> ***ETF** - Exchange-Traded Fund* - Борсово търгувания фонд е инвестиционен инструмент, който обединява група от ценни книжа във фонд който се търгува като отделна акция на дадена борса.

#### Поддържайте разходите ниски
LINK: https://www.bogleheads.org/wiki/Index_funds_and_ETFs_outside_of_the_US#Cost_and_expenses_related_to_UCITS_index_funds_and_ETFs
...
#### Данъчни съображения
LINK: https://www.bogleheads.org/wiki/Outline_of_non-US_domiciles#Tax_issues

Помислете за данъчната ефективност на вашите инвестиции. Целта е да минимизирате въздействието на данъците върху портфолиото ви. След като определите разпределението на активите си, но преди да изберете вашите конкретни индексни фондове проверете дали нямате достъп до друг фонд който би бил по-ефективен от данъчна гледна точка.
...
Нашата методология е да инвестираме в добре диверсифицирани, евтини индексни фондове търгувани на борси регулирани от ESMA.

## Поддържайте портфолиото си
LINK: https://www.bogleheads.org/wiki/Rebalancing
