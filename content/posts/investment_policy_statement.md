...
**Инвестиционна политика (ИП)** е документ, който определя вашите общи инвестиционни цели и задачи. Той описва стратегиите, които ще използвате за постигането на тези цели, и включва конкретна информация като [разпределение на активите](/posts/asset_allocation), толерантност към риск и изисквания за ликвидност.
...
3.  **Изберете подходящи инвестиции.** Търсете инструменти с ниски разходи, като например индексни фондове, за да улесните процеса.
